                          ...
                          itemBuilder: (index) {
                            return Column(
                              ...
                              children: [
                                                ...
                                                builder:
                                                  ...
                                                  return SizedBox(
                                                      ...
                                                      child: CustomAlertDialog(
                                                        ...
                                                        title:
                                                            "\nهل انت متأكد من  حذف الملف الطبي؟\n ملاحظة: لا يمكن استرجاع الملف بعد الحذف",
                                ...
                                CustomTextWidget(
                                  Txt:
                                      "  ${documentcontroller.documentDto[index].number} الصور \u{1F4F7}",
                                  color: ColorManager.grey1,
                                  size: Get.width / 21,
                                  fontweight: FontWeight.w300,
                                  spacing: 0,
                                ...
                                CustomTextWidget(
                                  Txt:
                                      "  ${documentcontroller.documentDto[index].code} \u{1F511}",
                                  color: ColorManager.grey1,
                                  size: Get.width / 21,
                                  fontweight: FontWeight.w300,
                                  spacing: 0,
